...
#           typeId 经 BinaryValueDecoder 解码为与 text 模式对齐的可读值；jsonb/interval/enum/数组
#           等矩阵外类型降级十六进制 + WARN 一次，见 protocol/CLAUDE.md）
